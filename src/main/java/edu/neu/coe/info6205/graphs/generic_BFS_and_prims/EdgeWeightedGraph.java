...
public class EdgeWeightedGraph {
    ...
    public EdgeWeightedGraph(int V) {
        ...
        this.V = V;
        this.E = 0;
        adj = (edu.neu.coe.info6205.graphs.BFS_and_prims.Bag<Edge>[]) new edu.neu.coe.info6205.graphs.BFS_and_prims.Bag[V];
        for (int v = 0; v < V; v++) {
            adj[v] = new edu.neu.coe.info6205.graphs.BFS_and_prims.Bag<Edge>();
        }
    }
    ...
    public Iterable<Edge> edges() {
        edu.neu.coe.info6205.graphs.BFS_and_prims.Bag<Edge> list = new Bag<Edge>();
        for (int v = 0; v < V; v++) {
            int selfLoops = 0;
            for (Edge e : adj(v)) {
                if (e.other(v) > v) {
